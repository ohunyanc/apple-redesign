  ...
  return (
    <Link href="/checkout">
        <div className="fixed bottom-10 right-10 z-50 flex h-14 w-14 cursor-pointer items-center justify-center rounded-full bg-gray-300">
            {items.length > 0 && (
                <span className="absolute -right-2 -top-2 z-50 flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-r from-green-600 to-violet-500 text-[10px] text-white">
                    {items.length}
                </span>
            )}
